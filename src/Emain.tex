...
% \newpage
% \section{Модель и числа ядра}


% \newpage
% \section{Энергия связи ядра. Дефект массы}


% \newpage
% \section{Радиоактивные распады}


% \newpage
% \section{Ядерная реакция}
...
% \chapter{Введение в физику}


% \newpage
% \section{Основные понятия физики}
