...
real tmin=-7pi,tmax=0;
path3 g=graph(li,tmin,tmax,operator..);
draw(yscale3(sc)*g,RoyalBlue);

triple li(real t){return (t,0,-r*sin(k*t));}
real tmin=0,tmax=8pi;
path3 g=graph(li,tmin,tmax,operator..);
draw(xscale3(sc)*g,RoyalBlue);


//dot
dot((0,-7pi*sc,0),L=Label("$S_1$",black),W,RoyalBlue+1mm);
dot((8pi*sc,0,0),L=Label("$S_2$",black),W,RoyalBlue+1mm);
dot((0,0,0),L=Label("$M$",black),E,black+1mm);


//dash
draw((0,0,0)--(0,-7pi*sc,0),dashed+gray);
